/*
  ...
  gengetopt --input=cxkcdpass.ggo --output-dir=./src/ --no-handle-error --include-getopt
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'n':	/* Generate passphrases containing exactly NUM_WORDS words..  */
          ...
          if (update_arg( (void *)&(args_info->num_words_arg), 
               &(args_info->num_words_orig), &(args_info->num_words_given),
              &(local_args_info.num_words_given), optarg, 0, "6", ARG_INT,
              check_ambiguity, override, 0, 0,
              "num-words", 'n',
              additional_error))
            goto failure;
