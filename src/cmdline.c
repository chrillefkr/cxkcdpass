/*
  ...
  gengetopt -l --input=cxkcdpass.ggo --no-handle-error --include-getopt --output-dir=./src/ 
...
const char *gengetopt_args_info_usage = "Usage: cxkcdpass [-h|--help] [-V|--version] [-wWORDFILE|--wordfile=WORDFILE]\n         [-mMIN_LENGTH|--min=MIN_LENGTH] [-MMAX_LENGTH|--max=MAX_LENGTH]\n         [-nNUM_WORDS|--numwords=NUM_WORDS] [-aACROSTIC|--acrostic=ACROSTIC]\n         [-i|--interactive] [-rREGEX|--regex-match=REGEX]\n         [-cCOUNT|--count=COUNT] [-dDELIM|--delim=DELIM]\n         [-R|--random-delimiters]\n         [-DVALID_DELIMITERS|--valid-delimiters=VALID_DELIMITERS]\n         [-sSEP|--sep=SEP] [-CENUM|--case=ENUM] [-v|--verbose]";
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->wordfile_given = 0 ;
  args_info->min_given = 0 ;
  args_info->max_given = 0 ;
  args_info->numwords_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->wordfile_arg = gengetopt_strdup ("eff-long");
  args_info->wordfile_orig = NULL;
  args_info->min_arg = 5;
  args_info->min_orig = NULL;
  args_info->max_arg = 9;
  args_info->max_orig = NULL;
  args_info->numwords_arg = 6;
  args_info->numwords_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->wordfile_help = gengetopt_args_info_help[2] ;
  args_info->min_help = gengetopt_args_info_help[3] ;
  args_info->max_help = gengetopt_args_info_help[4] ;
  args_info->numwords_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->wordfile_arg));
  free_string_field (&(args_info->wordfile_orig));
  free_string_field (&(args_info->min_orig));
  free_string_field (&(args_info->max_orig));
  free_string_field (&(args_info->numwords_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->wordfile_given)
    write_into_file(outfile, "wordfile", args_info->wordfile_orig, 0);
  ...
  if (args_info->numwords_given)
    write_into_file(outfile, "numwords", args_info->numwords_orig, 0);
      ...
      switch (c)
        ...
        case 'w':	/* Specify that the file WORDFILE contains the list of valid words from which to generate passphrases. Multiple wordfiles can be provided, separated by commas. Provided wordfiles: eff-long, eff-short, eff-special, legacy, spa-mich (Spanish), fin-kotus (Finnish), fr-freelang (French), fr-corrected.txt (French), pt-ipublicis (Portuguese), ita-wiki (Italian), ger-anlx (German), eff_large_de_sample.wordlist (German), nor-nb (Norwegian).  */
          ...
          if (update_arg( (void *)&(args_info->wordfile_arg), 
               &(args_info->wordfile_orig), &(args_info->wordfile_given),
              &(local_args_info.wordfile_given), optarg, 0, "eff-long", ARG_STRING,
          ...
          break;
        case 'm':	/* Generate passphrases containing words with at least MIN_LENGTH characters..  */
        
        
          if (update_arg( (void *)&(args_info->min_arg), 
               &(args_info->min_orig), &(args_info->min_given),
              &(local_args_info.min_given), optarg, 0, "5", ARG_INT,
              check_ambiguity, override, 0, 0,
              "min", 'm',
              additional_error))
            goto failure;
          ...
          break;
        case 'M':	/* Generate passphrases containing words with at most MAX_LENGTH characters..  */
        
        
          if (update_arg( (void *)&(args_info->max_arg), 
               &(args_info->max_orig), &(args_info->max_given),
              &(local_args_info.max_given), optarg, 0, "9", ARG_INT,
              check_ambiguity, override, 0, 0,
              "max", 'M',
              additional_error))
            goto failure;
          ...
          break;
        case 'n':	/* Generate passphrases containing exactly NUM_WORDS words..  */
        
        
          if (update_arg( (void *)&(args_info->numwords_arg), 
               &(args_info->numwords_orig), &(args_info->numwords_given),
              &(local_args_info.numwords_given), optarg, 0, "6", ARG_INT,
              check_ambiguity, override, 0, 0,
              "numwords", 'n',
              additional_error))
            goto failure;
        ...
        case 'r':	/* Limit passphrases to only include words matching the regex pattern REGEX (e.g. '^[a-z]*$')..  */
          ...
          if (update_arg( (void *)&(args_info->regex_match_arg), 
               &(args_info->regex_match_orig), &(args_info->regex_match_given),
